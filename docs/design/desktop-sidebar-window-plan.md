...
> **状态：v1.1 — 已实施（2026-09-24）**。侧栏与窗口切换代码已接入，逻辑测试通过；本次未做真实 Windows 桌面交互验收。
> 起草：2026-09-22；完成：2026-09-24
...
| 版本 | 内容 | 状态 |
|---|---|---|
| **2.1.0** | 移动端 P0（通知 / 锁屏封面、mini player 剩余时间、Android widget） | 已发布 |
| **2.2.0 之后** | **本计划**（桌面侧栏窗口） | 已实施；桌面 hover 与键盘导航留作后续候选 |
