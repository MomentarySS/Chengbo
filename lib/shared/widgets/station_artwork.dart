...
import '../../core/artwork/artwork_url.dart';
...
class StationArtwork extends StatelessWidget {
  ...
  /// 跳过低分辨率的 favicon，避免放大后模糊。与通知栏 [ArtworkUrlLogic] 同一套规则。
  static String? resolveArtworkUrl(String? raw) => ArtworkUrlLogic.resolve(raw);
